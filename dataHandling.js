...
class DataBaseHandling {
    ...
    insertProductInCart(cartId, productId) {
        ...
        let oldTotal = stmtCurrentTotal.get(cartId).total;
        let price = stmtProductPrice.get(productId).price;
